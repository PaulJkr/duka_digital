...
export default function Hero() {
  ...
  useEffect(() => {
    const controls = animate(0, 2000, {
      duration: 1.2,
      onUpdate(value) {
        priceRef.current.textContent = `Ksh. ${value.toFixed()}`;
      },
    });
        ...
        >
          <section className="flex flex-col gap-5 sm:items-center text-center lg:text-left lg:gap-6 lg:items-start">
            ...
            <p className="text-lg font-body text-black-300 sm:w-4/5">
              Millions of the world's most successful brands trust Duka Digital
          ...
          <div className="relative w-fit">
            ...
            >
              ...
              <div className="flex w-full items-center justify-between">
                <p>Modern Sofa</p>
                <p className="text-[#515151] font-medium">Ksh. 124.60</p>
              </div>
